...
export interface SageMakerPreprocessingImageRepoStackProps extends cdk.StackProps {
    repoUrl?: string;
    branch?: string;
...
export class SageMakerPreprocessingImageRepoStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: SageMakerPreprocessingImageRepoStackProps) {
        ...
        // CodeBuild Project
        this.buildProject = new codebuild.Project(this, "SageMakerPreprocessingImageBuild", {
...
`),
        ...
        new cdk.CfnOutput(this, "PreprocessingRepoUri", { value: this.repositoryUri });
    }
}
